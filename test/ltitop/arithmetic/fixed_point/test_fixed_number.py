...
def test_fixed_numbers():
    with FixedFormatArithmeticLogicUnit(format_=Q(7), rounding_method=nearest_integer) as alu:
        assert_interval_close(fixed(interval(-0.2, 0.1)), interval(-0.2, 0.1), atol=2**alu.format_.lsb)
